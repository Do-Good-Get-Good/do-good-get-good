...
import { StyleSheet, Text, Modal, View, Pressable, TextInput } from 'react-native'
    ...
    >
      <View style={styles.modalContainer}>
        <View style={styles.modal}>
          <Pressable style={[tw`absolute`, {right: -8, top: -8}]} onPress={() => {
            setEmail(null)
            setError(null)
            openModal(false)
          }}>
          ...
          <View style={tw`mt-10`}>
            <Text style={tw`text-lg`}>Vänligen fyll i din e-post för att återställa ditt lösenord.</Text>
            <Text>Om din e-post existerar kommer du få ett mail med ett nytt lösenord!</Text>
            <TextInput 
              style={[
